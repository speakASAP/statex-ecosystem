# Copilot Instructions — `statex-ecosystem`
...
- **Authoritative path**: `/home/ssf/Documents/Github/statex-ecosystem` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/statex-ecosystem.git`, branch `main`.
